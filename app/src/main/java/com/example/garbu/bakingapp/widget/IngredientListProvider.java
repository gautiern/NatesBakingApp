...
/**
 * RemoteViewsService for Widget to populate ingredient lisView
 */
...
public class IngredientListProvider implements RemoteViewsService.RemoteViewsFactory {
    ...
    private ArrayList<Ingredient> getIngredientList() {
        ...
        //retrieve the saved recipe from Shared Preferences
    ...
    public int getViewTypeCount() {
        // ListView shows "loading" found StackOverflow solution
